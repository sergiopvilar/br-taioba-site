if(!window.initVar){
  window.initVar = {
    ...
    meta: {},
    vapidKey: "BFTtgtUYeM0WGDZB2RjkcOgdTnQU6DeB4urBm7XZ7ZG119VgEld3BUElqO8tCaBwABeQHhTBl7f-tjR57zqEnT4",
    clientId: "4F94J6UVWZ5CV23MC73RXJWJ",
    pushOptInSetting: {"delay":86400,"message":{"body":"We will notify you about new products and exclusive promotions","title":"Never miss a sale","buttons":[{"label":"Later","order":1},{"label":"Allow","order":2}],"iconUrl":"https://cdn.shopify.com/s/files/1/0721/7555/0781/t/2/assets/grow-VA6EG7TJMEJCEX5GSE35B7Y1.webp"},"isEnabled":false,"showModal":true,"initialDelay":10},
    subscriberId: '',
    stockFulFilledPushCampaign: {
      isActive: true,
      uniqueId: '1IE2RIZGEZYD4PX9KQRLITED'
    },
    stockFulFilledEmailCampaign: {
      isActive: true,
      uniqueId: 'D6HEEGDTLDCD3ZTCFFJVQ42L'
    },
    stockFulFilledSmsCampaign: {
      isActive: true,
      uniqueId: 'N2DMSNBV3RCAKMBK9BRMAYJN'
    },
    priceDropPushCampaign: {
      isActive: true,
      uniqueId: 'QLVDK2KF7J75WTVXWXN1DYSP',
    },
    priceDropEmailCampaign: {
      isActive: true,
      uniqueId: 'IL8SUMU8B6YXHM7UJS7U7ML7',
    },
    priceDropSmsCampaign: {
      isActive: true,
      uniqueId: 'B8NJJQZ1RMHPATGDAHAKQY6C',
    },
    stockWidget: {
      ...
      backgroundColor: "#647659",
      textColor: "#ffffff",
      subscriptionText: "Avise-me quando chegar",
      subscribedText: "Avisaremos quando chegar",
      modalHtml: `<html>
<head>
...
<div class="modal" v-cloak id="el">
  <div class="modal-container">
    ...
    <h3 class="modal-title">Avise-me quando chegar</h3>
    <p class="notification-message">Te enviaremos um email para informar quando este produto voltar ao estoque.</p>
    ...
    <template v-if="selectedChannel==='email'">
      ...
      <small style="color: red" v-if="!isEmailValid">Informe um email válido</small>
    </template>
    ...
    <div v-if="dataEntered" class="gw-success-message alert alert-success complete"> Sua notificação foi cadastrada.
      <a href="#"
         class="action-close"
         @click.p.prevent="closeModal">Fechar</a>
    </div>
    ...
    <div class="marketing-container" v-if="shopifyMailingListEnabled">
      ...
      <label class="marketing-container-label" for="accepts_marketing">Deseja receber novidades?</label>
    </div>
  ...
  window.onload = function () {
    window.growCampaignPopUp = new Vue({
      ...
      data: {
        ...
        heading: "heading",
        subheading: "Te enviaremos um email para informar quando este produto voltar ao estoque.",
        notifyButtonTitle: "Avise-me",
        privacyText: "",
        emailWorkflowUniqueId: "D6HEEGDTLDCD3ZTCFFJVQ42L",
        smsWorkflowUniqueId: "N2DMSNBV3RCAKMBK9BRMAYJN",
        successText: "Sua notificação foi cadastrada.",
        successCloseText: "Fechar",
        optInMarketingText: "Deseja receber novidades?",
        email: "",
        phoneNumber: '',
...
.btn.btn-success.gw-button-widget {
    margin-bottom: 1rem;
	display: flex;
    width: 100%;
	font-size: 1.5rem;
...
.sold-out .shopify-payment-button__button {
display:none;
}

.notify-button{ border-color: rgb(100, 118, 89); background-color: rgb(100, 118, 89);  }
