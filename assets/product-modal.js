...
if (!customElements.get('product-modal')) {
  customElements.define('product-modal', function (_ModalDialog) {
    _inherits(ProductModal, _ModalDialog);

    function ProductModal() {
      _classCallCheck(this, ProductModal);

      return _possibleConstructorReturn(this, (ProductModal.__proto__ || Object.getPrototypeOf(ProductModal)).call(this));
    }

    _createClass(ProductModal, [{
      key: 'hide',
      value: function hide() {
        _get(ProductModal.prototype.__proto__ || Object.getPrototypeOf(ProductModal.prototype), 'hide', this).call(this);
      }
    }, {
      key: 'show',
      value: function show(opener) {
        _get(ProductModal.prototype.__proto__ || Object.getPrototypeOf(ProductModal.prototype), 'show', this).call(this, opener);
